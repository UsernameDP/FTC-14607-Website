          ...
          {navReferences.map((reference, index) => {
            return (
              <a
                ...
                key={index}
                className="text-lg xl:text-base hover:underline-transition hover:font-semibold hover:-translate-y-1 font-normal relative transition-all druation-1000 underline-props after:bg-FTC_RED after:bottom-0"
              >
                {reference.replace(/-/g, " ")}
              </a>
            );
